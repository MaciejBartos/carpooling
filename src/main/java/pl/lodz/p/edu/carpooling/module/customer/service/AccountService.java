...
import pl.lodz.p.edu.carpooling.module.customer.dto.AccountRolesDTO;
...
import pl.lodz.p.edu.carpooling.module.customer.service.converter.AccountToAccountDetailsForListConverter;
import pl.lodz.p.edu.carpooling.module.customer.service.converter.AccountToAccountDetailsResponseConverter;
...
public class AccountService {
    ...
    public List<AccountDetailsForList> getAccounts(GetAccountsSearchCriteriaRequest request) {
        List<Account> accounts = accountRepository.findAllWithSearchCriteria(request.getSearchCriteria());
